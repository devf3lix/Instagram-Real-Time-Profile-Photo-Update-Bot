...
//Piyasada ilklerdendir
  ...
  await page.type('input[name="username"]', 'f3lixblack'); //'KULLANICI_ADINIZ '  KULLANICI_ADINIZ yazan kısma yani tırnakları silmeden tırnakların içerisine kullanıcı adınızı yazınız
  // console.log("Kullanıcı adı textbox'ına kullanıcı adınız yazılıyor");
  await page.type('input[name="password"]', '0101201001Ca#'); // Aynı şekilde SIFRENIZ kısmına da o şekilde boşluk bırakmayın
